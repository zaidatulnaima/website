...
@section('content')
    <div class="content">
        <div class="container">
            <div class="row">
                <div class="col-lg-10">
                    <h1 class="text-header">Data Video</h1>
                </div>
                <div class="col-lg-2">
                    <a href="{{ url('/bhsIsyarat/video/create') }}" class="btn btn-primary" title="Tambah video">
                        Tambah Video
                    </a>
                </div>
            </div>
                ...
                <tbody class="text-center">
                    @foreach ($videos as $video)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('video.show', $video->id) }}" class="btn btn-info">Detail</a>
                                <a href="{{ route('video.edit', $video->id) }}" class="btn btn-warning">Edit</a>
                                <button onclick="handleDelete({{ $video->id }})" class="btn btn-danger">Hapus</button>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
