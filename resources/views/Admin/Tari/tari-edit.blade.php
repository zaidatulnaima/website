    ...
    <div class="content">
        <div class="container">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('tari.update', $vtari->id) }}" method="post"
                        ...
                        <div class="mb-3">
                            ...
                            @enderror
                            <img src="/storage/coverTari/{{ $vtari->cover }}" width="80">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            @error('video')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                            <video src="/storage/vtari/{{ $vtari->video }}" width="80"></video>
                        </div>
                        <button type="submit" class="btn btn-primary">Update</button>
                        <a href="{{ route('tari.index') }}" class="btn btn-light">Kembali</a>
                    </form>
                </div>
            </div>
        </div>
