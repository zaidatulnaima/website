<style>
    ...
    .jumbotron {
        align-items: center;
        display: flex;
        background-image: url('/assets/img/background/back0.jpeg');
            ...
            <div class="row text-center">
                <div class="container">
                    <form class="d-flex" role="search" style="width: 70%"; heig>
                        <input class="form-control me-2 bg-outline-dark" type="search" placeholder="Search" aria-label="Search">
            ...
            <div class="row mb-4" data-zanim-timeline="{}" data-zanim-trigger="scroll">
                <div class="col">
                    <div class="overflow-hidden">
                        <h2 class="fs-sm-5 mb-2" data-zanim-xs='{"duration":1.5,"delay":0}'>Tari
                        </h2>
                    </div>
                    <div class="overflow-hidden">
                        <p class="text-uppercase fs--1 text-black ls-1 mb-0" data-zanim-xs='{"duration":1.5,"delay":0.1}'>
                            Kumpulan video tutorial tentang tari</p>
                    </div>
                    <div class="overflow-hidden">
                ...
                @foreach ($vtari as $tari)
                    <div class="col-md-6 col-lg-4 mb-5">
                        <div class="flashcard-item mx-auto" data-bs-toggle="modal"
                            data-bs-target="#flashcardModal{{ $tari->id }}">
                            <div
                            ...
                            <img class="img-fluid" src="/storage/coverTari/{{ $tari->cover }}" alt="...">
                        </div>
                    </div>
                @endforeach
            </div>
...
<!-- flashcard Modals-->
@foreach ($vtari as $tari)
    <div class="flashcard-modal modal fade" id="flashcardModal{{ $tari->id }}" tabindex="-1"
        aria-labelledby="flashcardModal{{ $tari->id }}" aria-hidden="true">
