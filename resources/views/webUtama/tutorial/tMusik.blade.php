    ...
    <section class="page-section flashcard pt-3 pt-lg-5 pb-6 pb-lg-8 text-center" id="flashcard">
        <div class="container">
            <div class="row mb-4" data-zanim-timeline="{}" data-zanim-trigger="scroll">
                <div class="col">
                    <div class="overflow-hidden">
                        <h2 class="fs-sm-5 mb-2" data-zanim-xs='{"duration":1.5,"delay":0}'>Musik
                        </h2>
                    </div>
                    <div class="overflow-hidden">
                        <p class="text-uppercase fs--1 text-black ls-1 mb-0" data-zanim-xs='{"duration":1.5,"delay":0.1}'>
                            Kumpulan video tutorial tentang musik</p>
                    </div>
                    <div class="overflow-hidden">
            ...
            <div class="row justify-content-center">
                <!-- flashcard Item 1-->
                @foreach ($vmusik as $tmusik)
                    <div class="col-md-6 col-lg-4 mb-5">
                        <div class="flashcard-item mx-auto" data-bs-toggle="modal"
                            data-bs-target="#flashcardModal{{ $tmusik->id }}">
                            <div
                            ...
                            <img class="img-fluid" src="/storage/cover/{{ $tmusik->cover }}" alt="...">
                        </div>
                    </div>
                @endforeach
            </div>
...
<!-- flashcard Modals-->
@foreach ($vmusik as $tmusik)
    <div class="flashcard-modal modal fade" id="flashcardModal{{ $tmusik->id }}" tabindex="-1"
        aria-labelledby="flashcardModal{{ $tmusik->id }}" aria-hidden="true">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-8">
                                ...
                                <video autoplay controls class="border rounded w-100" style="margin-bottom: 20px">
                                    <source src="{{ asset('/storage/vmusik/' . $tmusik->video) }}" type="video/mp4">
                                </video>
